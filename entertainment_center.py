...
yevade_subramanyam = media.Movie(
    "Yevade Subramanyam",
    "A guy finds himself after a journey to Doodh Kashi",
    "https://upload.wikimedia.org/wikipedia/en/e/e6/Yevade_Subramanyam_first_poster.jpg",  # noqa
...
bahubali = media.Movie(
    ...
    decades old feud between two warring people.",
    "https://upload.wikimedia.org/wikipedia/en/7/7e/Baahubali_poster.jpg",
    "https://www.youtube.com/watch?v=sOEg_YZQsTI")

sultan = media.Movie(
    "Sultan (2016)",
    "A middle-aged wrestling champion (Salman Khan) \
    tries to make a comeback to represent India at the Olympics.",
...
manam = media.Movie(
    ...
    "https://upload.wikimedia.org/wikipedia/en/0/0c/Manam_poster.jpg",
    "https://www.youtube.com/watch?v=Y4Bq4SQc_eM")

oopiri = media.Movie(
    "Oopiri",
    "After he becomes a quadriplegic from an accident, \
    Vikram hires a young man to be his caregiver.",
    "https://upload.wikimedia.org/wikipedia/en/4/49/Oopiri_Telugu_film_Poster.jpg",  # noqa
    "https://www.youtube.com/watch?v=e1ddsJ38D5Q")

kumari_21f = media.Movie(
    "Kumari 21F",
    "A young man's love for his girlfriend \
    is tested by the rumors surrounding her.",
    "https://upload.wikimedia.org/wikipedia/en/1/11/Kumari_21F_poster.jpg",
